...
4. **Username:** `your_mongodb_username` (already set)
5. **Password:** `your_mongodb_password` (already set)
...
5. Connection string copy করো:
   ```
   mongodb+srv://your_mongodb_username:your_mongodb_password@cluster0.i9ueyks.mongodb.net/?appName=Cluster0
   ```
...
# Channels
CONTENT_CHANNEL_ID=-100XXXXXXXXXXXX
FORCE_JOIN_CHANNEL_ID=-100XXXXXXXXXXXX
...
**Example:**
```
https://t.me/YOUR_BOT_USERNAME?start=content_abc12345
```
...
|-------------|---------|------|-----------|
| Movie 1 | abc123 | video | =CONCATENATE("https://t.me/YOUR_BOT_USERNAME?start=content_", B2) |
| Movie 2 | xyz789 | video | =CONCATENATE("https://t.me/YOUR_BOT_USERNAME?start=content_", B3) |
    ...
    <script>
        ...
        contents.forEach(item => {
            ...
            btn.onclick = () => {
                ...
                tg.openTelegramLink(`https://t.me/YOUR_BOT_USERNAME?start=content_${item.copyId}`);
            };
